...
## Purpose
Create comprehensive manual/UI functional test cases for the InvenTree **Parts** module from the supplied problem statement and the official Parts documentation.
